...
public String user;
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(30, 56, 170, 20);

        jLabel2.setText("verify password");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(40, 146, 150, 30);

        resetpass.setText("jTextField1");
        getContentPane().add(resetpass);
        resetpass.setBounds(250, 60, 73, 22);

        verifypass.setText("jTextField2");
        getContentPane().add(verifypass);
        verifypass.setBounds(250, 150, 73, 22);
        ...
        jButton1.setBounds(240, 250, 72, 22);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(resetpass.getText().equals(verifypass.getText())){
...
pst.setString(1, verifypass.getText());
